            ...
            <Container>
                <Grid container spacing={4}>
                    ...
                    <Grid item xs={12} md={4} sx={{ textAlign: "left" }}>
                        ...
                        <Typography variant="body1" sx={{ py: 1 }}>This is the best trusted shop in the town for medicines</Typography>
                        <Box sx={{ py: 1 }} >
                ...
                <Typography variant="subtitle1" sx={{ color: "gray" }}>copyright @1990-2021 All right reserved by medi-care.com</Typography>
            </Container>
        </Box>
    );
};
